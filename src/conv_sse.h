/*
 * Viterbi decoder for convolutional codes - arm NEON (equivalent of Intel SSE/AVX) 
 *
 ...
 */
static __always_inline void _sse_metrics_k7_n4(const int16_t *val, const int16_t *out,
